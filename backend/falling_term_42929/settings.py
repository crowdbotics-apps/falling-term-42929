"""
Django settings for falling_term_42929 project.
...
ROOT_URLCONF = 'falling_term_42929.urls'
...
WSGI_APPLICATION = 'falling_term_42929.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_term_42929 API",
    "DESCRIPTION": "API documentation for falling_term_42929 App",
    "VERSION": "v1",
}
